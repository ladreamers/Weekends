...
public class ProductRepositoryTest {
    ...
    private static final BigDecimal BIG_DECIMAL_100 = BigDecimal.valueOf(100.99);
    private static final String PRODUCT_DESCRIPTION = "a TEST product added on reload";
    private static final String IMAGE_URL = "http://tineye.com/images/widgets/mona.jpg";
